...
if (isset($_SESSION['access_token']) && $_SESSION['access_token']) {
  ...
  $redirect_uri = 'https://ops.cloudops.net/googlegroups/oauth2callback.php';
  header('Location: ' . filter_var($redirect_uri, FILTER_SANITIZE_URL));
}


$service = new Google_Service_Directory($client);
//$service2 = new Google_Service_Directory($client);
$pageToken = NULL;
$optParams = array(
...
foreach($groups as $group) {
  ...
  echo "<b>" . $groupsnames.  " (". $groupsemails. ") has the following members: ".'</b><br>';
  $results2 = $service->members->listMembers($groupsemails);
  $members = $results2->getMembers();
